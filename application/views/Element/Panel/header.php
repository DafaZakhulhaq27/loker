            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <!-- Logo text --><span>
                            <!-- dark Logo text -->
                            <!-- <img src="<?php echo base_url(); ?>assets/material-pro/assets/images/logo-text.png" alt="homepage" class="dark-logo" />
                            Light Logo text
                            <img src="<?php echo base_url(); ?>assets/material-pro/assets/images/logo-light-text.png" class="light-logo" alt="homepage" /></span> -->
                    </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
