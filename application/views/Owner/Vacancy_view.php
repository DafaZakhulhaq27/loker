                                ...
                                <?php
                                    ...
                                    if($d->status == "dibuka"){
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                      <a  type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_ubah" style="color : white ;" onclick="change_vacancy('.$d->id_vacancy.')"><i class="fa fa-pencil" ></i> </a>
                                            </div>
                                            <div class="col-lg-12 col-md-12">
                                                      <a  type="button" class="btn btn-warning" style="color : white ;" onclick="close_vacancy('.$d->id_vacancy.')"><i class="fa fa-times" ></i> </a>
                                            </div                                                                                                                   
                                        </div>
                                        ';
                                    }
